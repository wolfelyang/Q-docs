...
![](/DrillingProblems/cli-gif2.gif )

![](/DrillingProblems/cli-gif3.gif )
...
```
![](/DrillingProblems/cli-gif10.gif )
...
* In Maana Q 3.1.0 or later just run the `gql maddheaders` command
  ```bash
    $ gql maddheaders
  ```
  ![](/DrillingProblems/cli-gif11.gif )
...
```
  ...
  ![](/DrillingProblems/cli-gif13.gif )
